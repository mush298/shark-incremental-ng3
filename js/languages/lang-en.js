...
LANGUAGES.EN = {
    ...
    text: {
        ...
        'tab-corrupted-assembler': toTextStyle('Corrupted','corruption') + " Assembler", 
        ...
        'progress-21-text': r => `Reach ${format(r)} ${toTextStyle('Infinity Points','infinity')} to unlock a new ${toTextStyle('Infinity','infinity')} feature (NYI)`, 
