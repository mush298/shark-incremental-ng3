...
function updateSingularityTemp() {
    tmp.bh_reduction = player.inf.corrupt ? E('1e-10') : tmp.ss_difficulty ? E(.5) : player.singularity.bh.gte(8) ? E(1) : Decimal.div(1,player.singularity.bh.sub(player.research.dm1).max(0).pow(2).div(20).add(1))
